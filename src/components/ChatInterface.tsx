        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {currentChat.messages.length > 0 ? 'Last active ' + format(new Date(currentChat.messages[currentChat.messages.length - 1].created_at), 'MMM d, h:mm a') : t('messages.startConversation')}
            </p>
          </div>
        </div>
      </div>
